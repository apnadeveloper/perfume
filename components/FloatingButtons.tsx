...
const FloatingButtons: React.FC = () => {
  ...
  const openWhatsApp = () => {
    window.open('https://wa.me/447848893414', '_blank');
  };
      ...
      <AnimatePresence>
        {showTopBtn && (
          <motion.button
            ...
            exit={{ opacity: 0, y: 20 }}
            onClick={scrollToTop}
            className="fixed bottom-6 right-6 z-50 bg-brand-pink text-brand-chocolate p-3 md:p-4 rounded-full shadow-lg flex items-center justify-center hover:bg-white transition-colors"
