      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              ...
              Experience the scent that defines you.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#home" className="text-gray-400 hover:text-brand-pink transition-colors text-sm">Home</a></li>
              <li><a href="#perfumes" className="text-gray-400 hover:text-brand-pink transition-colors text-sm">Shop</a></li>
              <li><a href="#about" className="text-gray-400 hover:text-brand-pink transition-colors text-sm">About Us</a></li>
              <li><a href="#contact" className="text-gray-400 hover:text-brand-pink transition-colors text-sm">Contact</a></li>
            </ul>
          </div>

          {/* Service */}
          <div>
            <h3 className="text-white font-bold uppercase tracking-wider mb-6">Customer Care</h3>
            <ul className="space-y-3">
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-sm text-center md:text-left">
            © {new Date().getFullYear()} L'Odeur Exquise. All rights reserved.
          </p>
          <div className="flex space-x-6">
            <a href="#" className="text-gray-400 hover:text-brand-pink transition-colors"><Instagram size={20} /></a>
            <a href="#" className="text-gray-400 hover:text-brand-pink transition-colors"><Facebook size={20} /></a>
            <a href="#" className="text-gray-400 hover:text-brand-pink transition-colors"><Twitter size={20} /></a>
          </div>
        </div>
      </div>
    </footer>
