    ...
    <section id="menu" className="py-20 bg-zinc-900/50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-serif text-white">The Menu</h2>
          <p className="text-gray-400 mt-4 max-w-xl mx-auto">Explore our complete range of exquisite fragrances, crafted for every occasion and personality.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {menuItems.map((item, index) => (
            <motion.div
              ...
              className="glass-panel p-4 rounded-lg hover:bg-white/5 transition-colors flex flex-col items-start"
            >
              <img 
                src={item.image} 
                alt={item.name} 
              ...
              <div className="w-full text-center md:text-left">
                <h3 className="text-xl font-serif text-brand-pink">{item.name}</h3>
